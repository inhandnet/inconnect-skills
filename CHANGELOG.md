...
- **Initial release**: Skills for managing the InConnect (InVPN) platform via the `ics` CLI
...
- **Command references**: Auto-generated per-subcommand docs under `references/commands/`, kept in sync with `ics-cli` releases
